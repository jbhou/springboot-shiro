...
import com.test.springboot.shiro.service.internal.impl.DeviceImpl;

/**
 * ClassName:DeviceFactory <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2018年5月22日 下午7:18:09 <br/>
 * 
 * @author lenovo
 * @version 1.0.0
 * @see
 */
@Factory(target = Device.class)
public class DeviceFactory {
    @Autowired
    private DeviceDao deviceDao;

    public Device createDevice(ProductLine productLine, DeviceEntity entity) {
        // TODO Auto-generated method stub
        DeviceImpl device = new DeviceImpl(deviceDao, entity, productLine);
        return device;
    }
}
